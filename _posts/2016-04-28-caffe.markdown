...
This content in this blog was written by my AFRL team and I for Caffe newbies and was approved for public released: 88ABW-2015-5479. The views expressed here are my opinion and do not reflect the opinion or position of my employeer (current or previous).
...
For example, the [create_label_file.py](link) FIX script creates a training and validation text file for [Kaggle's Dog vs Cats](https://www.kaggle.com/c/dogs-vs-cats/data) competition.
